...
print("Proporciona tu Fecha(día-mes-año): ")
date = input()

print("Proporciona tu Nombre: ")
Name = input()

print("Proporciona tu Apellido: ")
Last = input()

print("Proporciona tu matricula: ")
Matricula = input()
...
while(1):
    ...
    if(len(hrValues)==100):
            ...
            num_oxigenacion = calc_hr_and_spo2(irValues, redValues)[2]
            
            #print(irValues)
            #print(redValues)
            print("HR:",analisisHR2(hrValues, miliValues, 1))
            num_cardiaco = analisisHR2(hrValues, miliValues, 1)
            #recibir valores y mandar a query aquí
